...
// Starts the application with JDWP debug agent on port 5007 (suspend=n so the app boots immediately)
tasks.register<org.springframework.boot.gradle.tasks.run.BootRun>("bootRunDebug") {
    description = "Runs the Spring Boot application with a remote-debug agent on port 5007."
    group = "application"
    mainClass.set("com.medical.examination.ExaminationApplicationKt")
