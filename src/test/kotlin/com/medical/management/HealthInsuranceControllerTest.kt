...
class HealthInsuranceControllerTest {
    ...
    private val healthInsurance1 = HealthInsurance(
        id = 1L,
        name = "Health Plus",
    ...
    private val healthInsurance2 = HealthInsurance(
        id = 2L,
        name = "Basic Care",
    ...
    fun `GET health-insurances should return all health insurances`() {
        ...
        mockMvc.perform(get("/health-insurances"))
    ...
    fun `POST health-insurances should create health insurance`() {
        val newHealthInsurance = HealthInsurance(
            name = "New Insurance",
        ...
        mockMvc.perform(post("/health-insurances")
